                  ...
                  <span>
                    <Container className="quote-card quote-card-m py-4">
                      ...
                      <Container className="justify-content-center text-center mt-2 align-items-center">
                        ...
                        <a className="mx-2 share-button share-facebook" target="_blank" aria-label="Share on Facebook" rel="noreferrer" href={`https://www.facebook.com/dialog/share?app_id=143643636297368&display=popup&href=https://www.1001nuggets.com/quote/${quotes[index].realID}&redirect_uri=https://www.1001nuggets.com/quote/${quotes[index].realID}`}><FaFacebookF/></a>
