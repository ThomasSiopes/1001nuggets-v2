                  ...
                  <span>
                    <Container className="quote-card quote-card-m py-4">
                      ...
                      <Container className="justify-content-center text-center mt-2 align-items-center">
                        ...
                        <a className="mx-2 share-button share-facebook" target="_blank" aria-label="Share on Facebook" rel="noreferrer" href={`https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=https%3A%2F%2Fwww.1001nuggets.com/quote/${quotes[index].realID}%2F&display=popup&ref=plugin&src=share_button`}><FaFacebookF/></a>
