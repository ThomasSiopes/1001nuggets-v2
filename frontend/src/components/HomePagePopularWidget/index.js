...
function HomePagePopularWidget() {
    const authorList = [
        ...
        {name: "Oscar Wilde", realID:"Oscar-Wilde"},
        {name: "Maya Angelou", realID:"Maya-Angelou"},
        {name: "George Bernard Shaw", realID:"George-Bernard-Shaw"},
        {name: "Eleanor Roosevelt", realID:"Eleanor-Roosevelt"},
        {name: "Aristotle", realID:"Aristotle"},
        {name: "Confucius", realID:"Confucius"},
        {name: "Will Rogers", realID:"Will-Rogers"},
        {name: "Cicero", realID:"Cicero"},
        {name: "Josh Billings", realID:"Josh-Billings"},
    ...
    const topicList = [
        ...
        {name: "Husbands & Wives", realID: "Husbands-and-Wives"},
        ...
        {name: "Winners & Losers", realID: "Winners-and-Losers"},
    ...
    const proverbList = [
        ...
        {name: "Danish Proverbs ", realID: "Danish-proverb"},
